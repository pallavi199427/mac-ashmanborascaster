...
def api_speedtest_run():
    ...
    _speedtest_result.update({"status": "running"})
...
<body>
  ...
  <div class="control-bar">
    ...
    <div class="control-right">
      ...
      <button class="btn-bwcheck" id="btn-bwcheck" onclick="runSpeedTest()" title="Test upload bandwidth before going live">BW CHECK</button>
    ...
    <div class="right-sidebar">
      ...
      <div class="sidebar-panel">
        ...
        <div class="panel-body" id="net-stats">
          ...
          <div id="bw-result-area" style="display:none">
            <div class="bw-divider"></div>
            <div class="stat-row"><span class="stat-label">Upload Speed</span><span class="stat-value" id="bw-speed">-</span></div>
            <div class="stat-row"><span class="stat-label">Required</span><span class="stat-value" id="bw-required">-</span></div>
            <div class="stat-row"><span class="stat-label">Tested</span><span class="stat-value" id="bw-tested-at" style="font-size:11px">-</span></div>
            <div class="bw-verdict" id="bw-verdict"></div>
            <div class="bw-suggestion" id="bw-suggestion" style="display:none"></div>
          </div>
        </div>
